...
export const $GetAllAccountOutputBody = {
  ...
  required: ['accounts', 'message', 'nextC˝ursor', 'hasMore'],
  type: 'object',
} as const;
...
export const $GetAllJumaahOutputBody = {
  ...
  required: ['jumaahs', 'message', 'nextC˝ursor', 'hasMore'],
  type: 'object',
} as const;
...
export const $GetAllMusalahOutputBody = {
  ...
  required: ['musalahs', 'message', 'nextC˝ursor', 'hasMore'],
  type: 'object',
} as const;
...
export const $GetAttendeesResponseBody = {
  ...
  required: ['attendees', 'message', 'nextC˝ursor', 'hasMore'],
  type: 'object',
} as const;
