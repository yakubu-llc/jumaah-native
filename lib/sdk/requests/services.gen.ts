...
import type { GetAllAccountsData, GetAllAccountsResponse, CreateAccountData, CreateAccountResponse, DeleteAccountData, DeleteAccountResponse, GetAccountByIdData, GetAccountByIdResponse, UpdateAccountData, UpdateAccountResponse, HealthCheckResponse, GetAllJumaahsData, GetAllJumaahsResponse, CreateJumaahData, CreateJumaahResponse, CreateAttendeeData, CreateAttendeeResponse, DeleteJumaahData, DeleteJumaahResponse, GetJumaahByIdData, GetJumaahByIdResponse, UpdateJumaahData, UpdateJumaahResponse, GetAttendeesData, GetAttendeesResponse, GetAttendeeCountData, GetAttendeeCountResponse, DeleteAttendeeData, DeleteAttendeeResponse, GetAttendeeData, GetAttendeeResponse, UpdateAttendeeData, UpdateAttendeeResponse, GetAllMusalahsData, GetAllMusalahsResponse, CreateMusalahData, CreateMusalahResponse, DeleteMusalahData, DeleteMusalahResponse, GetMusalahByIdData, GetMusalahByIdResponse, UpdateMusalahData, UpdateMusalahResponse } from './types.gen';
...
export class AccountService {
     ...
     * @throws ApiError
     */
    public static getAllAccounts(data: GetAllAccountsData = {}): CancelablePromise<GetAllAccountsResponse> {
     ...
     * @throws ApiError
     */
    public static getAccountById(data: GetAccountByIdData): CancelablePromise<GetAccountByIdResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/account/{id}',
            path: {
...
export class JumaahService {
     ...
     * @throws ApiError
     */
    public static getAllJumaahs(data: GetAllJumaahsData = {}): CancelablePromise<GetAllJumaahsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/jumaah',
            query: {
     ...
     * @throws ApiError
     */
    public static createAttendee(data: CreateAttendeeData): CancelablePromise<CreateAttendeeResponse> {
        return __request(OpenAPI, {
            method: 'POST',
     ...
     * @throws ApiError
     */
    public static getAttendeeCount(data: GetAttendeeCountData): CancelablePromise<GetAttendeeCountResponse> {
        return __request(OpenAPI, {
            method: 'GET',
     ...
     * @throws ApiError
     */
    public static deleteAttendee(data: DeleteAttendeeData): CancelablePromise<DeleteAttendeeResponse> {
        return __request(OpenAPI, {
            method: 'DELETE',
     ...
     * @throws ApiError
     */
    public static updateAttendee(data: UpdateAttendeeData): CancelablePromise<UpdateAttendeeResponse> {
        return __request(OpenAPI, {
            method: 'PUT',
            url: '/jumaah/{id}/attendees/{account_id}',
            path: {
...
export class MusalahService {
     ...
     * @throws ApiError
     */
    public static getAllMusalahs(data: GetAllMusalahsData = {}): CancelablePromise<GetAllMusalahsResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/musalah',
            query: {
     ...
     * @throws ApiError
     */
    public static getMusalahById(data: GetMusalahByIdData): CancelablePromise<GetMusalahByIdResponse> {
        return __request(OpenAPI, {
            method: 'GET',
            url: '/musalah/{id}',
            path: {
